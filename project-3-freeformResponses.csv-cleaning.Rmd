...
```{r}
schema <- read_csv('project-3-kaggle/schema.csv')
mcq <- read_csv('project-3-kaggle/multipleChoiceResponses.csv')
ff <- read_csv('project-3-kaggle/freeformResponses.csv')
```
...
So, the final list containing the non-missing values from the 35 columns pertaining to data science skills is named `ff_non_na`. Hopefully, this list can be useful in finding some insights about which skills are valued by data science practitioners and learners.